...
/**
 * Routing System
 * @author Adal Khan 10 SEP to 03 OCT 2024
 */
...
class Web {
    ...
    public  static function init() { self::startSession(); }
    private static function startSession() { if (session_status() === PHP_SESSION_NONE) { session_start(); } }
    public  static function get($path, $callback) {self::$routes['GET'][$path] = $callback; }
    public  static function post($path, $callback) { self::$routes['POST'][$path] = $callback; }
